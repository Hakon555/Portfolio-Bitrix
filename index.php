	...
	<div class="products-col">
		...
		<div class="products-area products-area-all choosen-products-area">
			<div class="products">
				...
				<a class="name" href="/">Jaket Of Prince</a>
				<p>Valo lagla kinen na kinla poth mapen</p>
				<p class="price">$28</p>
			...
			<div class="products">
				<img src="<?=SITE_TEMPLATE_PATH?>/images/product4.jpg" alt="">
				<a class="name" href="/">Jaket Of Prince</a>
				<p>Valo lagla kinen na kinla poth mapen</p>
				<p class="price">$28</p>
				<div class="ad-to-cart">
			...
			<div class="products">
				<img src="<?=SITE_TEMPLATE_PATH?>/images/product6.jpg" alt="">
				<a class="name" href="/">Jaket Of Prince</a>
				<p>Valo lagla kinen na kinla poth mapen</p>
				<p class="price">$28</p>
				<div class="ad-to-cart">
		...
		<div class="products-area products-area-kids">
			<div class="products">
				<img src="<?=SITE_TEMPLATE_PATH?>/images/product2.jpg" alt="">
				<a class="name" href="/">Jaket Of Prince</a>
				<p>Valo lagla kinen na kinla poth mapen</p>
