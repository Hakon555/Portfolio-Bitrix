				...
				<div class="footer-blocks">
                    ...
                    <div class="block-2">
                        ...
                        <?$APPLICATION->IncludeComponent("bitrix:menu", "new_bottom_menu", Array(
                            ...
                            "ROOT_MENU_TYPE" => "newbottom1",	// Тип меню для первого уровня
                    ...
                    <div class="block-3">
                        ...
                        <?$APPLICATION->IncludeComponent("bitrix:menu", "new_bottom_menu", Array(
                            ...
                            "MENU_CACHE_TYPE" => "N",	// Тип кеширования
                            "MENU_CACHE_USE_GROUPS" => "Y",	// Учитывать права доступа
                            "ROOT_MENU_TYPE" => "newbottom2",	// Тип меню для первого уровня
                            "USE_EXT" => "N",	// Подключать файлы с именами вида .тип_меню.menu_ext.php
                            "COMPONENT_TEMPLATE" => "new_bottom_menu"
                        ),
                            false
                    ...
                    <div class="block-4">
                        ...
                        <?$APPLICATION->IncludeComponent("bitrix:menu", "new_bottom_menu", Array(
                            ...
                            "MENU_CACHE_TYPE" => "N",	// Тип кеширования
                            "MENU_CACHE_USE_GROUPS" => "Y",	// Учитывать права доступа
                            "ROOT_MENU_TYPE" => "newbottom3",	// Тип меню для первого уровня
                            "USE_EXT" => "N",	// Подключать файлы с именами вида .тип_меню.menu_ext.php
                            "COMPONENT_TEMPLATE" => "new_bottom_menu"
                        ),
                            false
